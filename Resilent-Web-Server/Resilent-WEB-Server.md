...
![](images/media/image37.png){width="6.268055555555556in"
...
1️⃣ Register domain in BigRock
...
3️⃣ Update nameservers in BigRock
...
- **A record** → Alias → ELB
  ...
  - Go to **EC2 → Load Balancers → your ALB → Description → DNS Name**

  - **2. Go to your hosted zone in Route 53**

  - Hosted Zone: your domain, e.g., example.com.

  - **3. Create an "A" or "ALIAS" record**

  - Click **Create Record**.

  - Choose **Record Type: A -- IPv4 address**.

  - **Alias:** Yes → choose **Alias to Application and Classic Load
    Balancer**.

  - In **Route traffic to**, select your ALB from the dropdown (AWS will
    resolve the DNS for you automatically).
...
![](images/media/image42.png){width="5.206911636045494in"
height="2.3513593613298336in"}

![](images/media/image43.png){width="6.107727471566054in"
height="1.745161854768154in"}
...
![](images/media/image44.png){width="6.268055555555556in"
height="1.1145833333333333in"}

2️⃣ Refresh → different hostnames

![](images/media/image45.png){width="6.268055555555556in"
height="1.0208333333333333in"}

If your network is not showing use mobile data or any other isp
connections to load it usually takes about 1-2 hrs

![](images/media/image46.png){width="3.229617235345582in"
height="1.354355861767279in"}

![](images/media/image47.png){width="4.031812117235345in"
height="2.166969597550306in"}

NSlookup check if the browser is not resolving do this here is the
correct output.

![](images/media/image48.png){width="4.117328302712161in"
height="2.9043897637795277in"}
